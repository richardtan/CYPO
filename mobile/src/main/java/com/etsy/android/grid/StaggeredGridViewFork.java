 ...
 */
public class StaggeredGridViewFork extends ExtendableListView {
    ...
    public StaggeredGridViewFork(final Context context) {
        this(context, null);
    }

    public StaggeredGridViewFork(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StaggeredGridViewFork(final Context context, final AttributeSet attrs, final int defStyle) {
    ...
    private void layoutGridChild(final View child, final int position,
        ...
        if (flowDown) {
            ...
            gridChildTop = getSafeBottom(column); // FORKED -> replaces code commented above
            ...
            gridChildBottom = getSafeTop(column); // FORKED -> replaces code commented above
    ...
    private void offsetColumnTopAndBottom(final int offset, final int column) {
        if (offset != 0) {
            ...
            // FORKED -> replaces code commented above
    ...
    protected void onChildrenDetached(final int start, final int count) {
        ...
        //Arrays.fill(mColumnBottoms, 0);
        Arrays.fill(mColumnBottoms, Integer.MIN_VALUE); // FORKED -> replaces commented code above
    ...
    private int getHighestPositionedBottomColumn() {
        ...
        for (int i = 0; i < mColumnCount; i++) {
            ...
            if (Integer.MIN_VALUE != bottom && bottom < highestPositionedBottom) { // FORKED -> replaces commented code above
    ...
    private int getLowestPositionedBottomColumn() {
        ...
        for (int i = 0; i < mColumnCount; i++) {
            ...
            if (Integer.MIN_VALUE != bottom && bottom > lowestPositionedBottom) { // FORKED -> replaces commented code above
    ...
    private int getLowestPositionedTopColumn() {
        ...
        for (int i = 0; i < mColumnCount; i++) {
            ...
            if (Integer.MAX_VALUE != top && top > lowestPositionedTop) { // FORKED -> replaces commented code above
    ...
    private int getHighestPositionedTopColumn() {
        ...
        for (int i = 0; i < mColumnCount; i++) {
            ...
            if (Integer.MAX_VALUE != top && top < highestPositionedTop) { // FORKED -> replaces commented code above
