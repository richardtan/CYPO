...
import com.etsy.android.grid.StaggeredGridViewFork;
 ...
 *  * Card Grid View.
 * It uses an {@link CardGridStaggeredArrayAdapterFork} to populate items.
 * </p>
 * Usage:
 * <pre><code>
 ...
 */
public class CardGridStaggeredViewFork extends StaggeredGridViewFork {
     ...
     */
    protected CardGridStaggeredArrayAdapterFork mAdapter;
    ...
    public CardGridStaggeredViewFork(Context context) {
        super(context);
        init(null, 0);
    }

    public CardGridStaggeredViewFork(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public CardGridStaggeredViewFork(Context context, AttributeSet attrs, int defStyle) {
    ...
    /**
     * Forces to use a {@link CardGridStaggeredArrayAdapterFork}
     *
     * @param adapter
     */
    @Override
    public void setAdapter(ListAdapter adapter) {
        if (adapter instanceof CardGridStaggeredArrayAdapterFork){
            setAdapter((CardGridStaggeredArrayAdapterFork)adapter);
        }else{
    ...
    /**
     * Set {@link CardGridStaggeredArrayAdapterFork} and layout used by items in CardGridStaggeredView
     *
     * @param adapter {@link CardGridStaggeredArrayAdapterFork}
     */
    public void setAdapter(CardGridStaggeredArrayAdapterFork adapter) {
        super.setAdapter(adapter);
     ...
     * @param cardAdapter    {@link CardGridStaggeredArrayAdapterFork} cardAdapter
     */
    public void setExternalAdapter(ListAdapter adapter, CardGridStaggeredArrayAdapterFork cardAdapter) {
