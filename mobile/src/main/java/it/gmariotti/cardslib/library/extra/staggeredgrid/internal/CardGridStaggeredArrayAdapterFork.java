 ...
 * Use it with a {@link CardGridStaggeredViewFork}.
 * </p>
 * Usage:
 * <pre><code>
 ...
 */
public class CardGridStaggeredArrayAdapterFork extends BaseCardArrayAdapter {

    protected static String TAG = "CardGridStaggeredArrayAdapters";

    /**
     * {@link CardGridStaggeredViewFork}
     */
    protected CardGridStaggeredViewFork mCardGridView;
     ...
     */
    public CardGridStaggeredArrayAdapterFork(Context context, List<Card> cards) {
        super(context, cards);
    }
     ...
     */
    public CardGridStaggeredViewFork getCardGridView() {
     ...
     */
    public void setCardGridView(CardGridStaggeredViewFork cardGridView) {
